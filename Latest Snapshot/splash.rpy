init python:
    menu_trans_time = 1
    splash_message_default = "null"
    splash_messages = [
    "Listen, I didnt choose this."
    ]
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "Individuals suffering from anxiety or depression may not have a safe experience playing this. For content warnings, please visit https://dokidokiextended.blogspot.com/2021/10/cw.html."
        "Please note that this is a fan-made modification to the game, the developers are in no way affiliated with Team Salvato."
        menu:
            "By playing, you agree that you are at least 13 years of age, and you consent to your exposure of highly disturbing content."
            "I agree.":
                pass
